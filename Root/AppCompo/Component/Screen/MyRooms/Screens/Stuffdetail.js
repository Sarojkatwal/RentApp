        ...
        <ScrollView>
          <Card>
              ...
              <TouchableOpacity
                onPress={() =>
                  this.props.navigation.push("ShowImage", {
                    uri: this.state.img[this.state.a - 700],
                  })
                }
              >
                <Card.Cover
                  source={{ uri: this.state.img[this.state.a - 700] }}
                  style={styles.images}
                />
              </TouchableOpacity>
              <Card.Title
                ...
                left={(props) => (
                  <IconButton
                    {...props}
                    size={40}
                    color={this.state.a == 700 ? "grey" : "white"}
            ...
            {!this.state.isSwitchOn ? (
              ...
              <Editdetails
                {...this.props}
                keys={this.props.stuff.key}
                roomData={this.props.stuff.roomData}
              ></Editdetails>
            )}
          </Card>
        </ScrollView>
